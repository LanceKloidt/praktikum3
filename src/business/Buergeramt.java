...
public class Buergeramt {
    	...
    	String strasseHNr, String[] dienstleistungen){
  	    ...
  	    this.geoeffnetVon = geoeffnetVon;
   	    ...
   	    if(dienstleistungen == null) {
   	    	throw new IllegalArgumentException("Die Vorgegebenen Dienstleistungen sind nicht korrekt");
   	    }
   	    setDienstleistungAusStringArray(dienstleistungen);
    }
	...
	private void setDienstleistungAusStringArray(String[] dienstleistungen) {
		...
		for(String s: dienstleistungen) ald.add(s);
		this.dienstleistungen = ald;
	}
}
