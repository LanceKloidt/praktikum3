   ...
   private void initListener() {
    ...
    private void nehmeBuergeramtAuf(){
    	try{
    		...
    		baModel.addBuergeramt(buergeramt);
    ...
    public void zeigeBuergeraemterAn(){
    	if(baModel.getBuergeraemter().size()>0){
    		StringBuffer text = new StringBuffer();
    		for(Buergeramt b : baModel.getBuergeraemter()) {
    ...
    private void schreibeBuergeraemterInDatei(String typ) {
    	baControl.schreibeBuergeraemterInDatei(typ, baModel.getBuergeraemter());
    }
